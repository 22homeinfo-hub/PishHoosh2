...
| `MINI_APP_URL` | آدرس عمومی و HTTPS مینی‌اپ (`https://دامنهٔ-شما/app`)؛ برای فعال‌شدن دکمهٔ ورود به مینی‌اپ در تلگرام |
...
| بخش | کار |
|---|---|
| **پروژه‌ها** | لیست پروژه‌های فعال از گوگل‌شیت + فیلدهای لازم هرکدام. با یک کلیک روی پروژه، چتِ تخمین قیمتِ همان پروژه باز می‌شود و ربات اطلاعات فایل را می‌پرسد و قیمت تخمینی را اعلام می‌کند. |
