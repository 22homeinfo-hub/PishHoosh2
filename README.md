...
3. سرویس را ری‌استارت کنید. بات **خودش** دکمهٔ منوی چت (کنار کادر نوشتن در چت خصوصی) را روی
   ...
   ```
   علاوه بر آن، بعد از به اشتراک گذاشتن شماره، یک دکمهٔ «📱 تخمین قیمت در مینی‌اپ» هم برای
...
| دکمهٔ مینی‌اپ در تلگرام نیست | `MINI_APP_URL` تنظیم نشده یا `https` نیست | لاگ سرویس و `npm run doctor` را ببینید |
