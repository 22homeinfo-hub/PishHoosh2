...
### اتصال به تلگرام (یک‌بار)

1. سرویس را دیپلوی کنید و آدرس عمومی‌اش را داشته باشید (مثلاً `https://diyar-bot.up.railway.app`).
2. در `.env` یا متغیرهای Railway بگذارید:
   ```
   MINI_APP_URL=https://diyar-bot.up.railway.app/app
   ```
3. سرویس را ری‌استارت کنید. بات **خودش** دکمهٔ منوی چت (کنار کادر نوشتن در چت خصوصی) را روی
   مینی‌اپ تنظیم می‌کند و در لاگ می‌نویسد:
   ```
   📱 دکمهٔ منوی مینی‌اپ فعال شد: https://diyar-bot.up.railway.app/app
   ```
